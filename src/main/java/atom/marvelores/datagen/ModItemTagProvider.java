...
public class ModItemTagProvider extends FabricTagsProvider.ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider registries) {
        ...
        valueLookupBuilder(ItemTags.SWORDS)
                .add(ModItems.VIBRANIUM_SWORD).add(ModItems.ADAMANTIUM_SWORD);
        valueLookupBuilder(ItemTags.PICKAXES)
                .add(ModItems.VIBRANIUM_PICKAXE).add(ModItems.ADAMANTIUM_PICKAXE);
        valueLookupBuilder(ItemTags.SHOVELS)
                .add(ModItems.VIBRANIUM_SHOVEL).add(ModItems.ADAMANTIUM_SHOVEL);
        valueLookupBuilder(ItemTags.AXES)
                .add(ModItems.VIBRANIUM_AXE).add(ModItems.ADAMANTIUM_AXE);
        valueLookupBuilder(ItemTags.HOES)
                .add(ModItems.VIBRANIUM_HOE).add(ModItems.ADAMANTIUM_HOE);
        ...
        valueLookupBuilder((ModTags.Items.VIBRANIUM_REPAIR))
                .add(ModItems.VIBRANIUM).add(ModItems.ADAMANTIUM);


        valueLookupBuilder(ItemTags.HEAD_ARMOR)
                .add(ModItems.VIBRANIUM_HELMET).add(ModItems.ADAMANTIUM_HELMET);
        valueLookupBuilder(ItemTags.CHEST_ARMOR)
                .add(ModItems.VIBRANIUM_CHESTPLATE).add(ModItems.ADAMANTIUM_CHESTPLATE);
