...
public class ModArmorMaterials {
    public static final RegistryEntry<ArmorMaterial> VIBRANIUM_ARMOR_MATERIAL = registerArmorMaterial("vibranium",
    ...
    public static RegistryEntry<ArmorMaterial> registerArmorMaterial(String name, Supplier<ArmorMaterial> material) {
        return Registry.registerReference(Registries.ARMOR_MATERIAL, Identifier.of(MarvelOres.MOD_ID, name), material.get());
    }
}