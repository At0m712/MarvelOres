package atom.marvelores.screen.custom;
...
public class CrusherScreen extends HandledScreen<CrusherScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(MarvelOres.MOD_ID, "textures/gui/crusher/crusher_gui.png");
    private static final Identifier ARROW_TEXTURE =
            Identifier.of(MarvelOres.MOD_ID, "textures/gui/arrow_progress.png");
